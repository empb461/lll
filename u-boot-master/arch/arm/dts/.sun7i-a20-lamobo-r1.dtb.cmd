cmd_arch/arm/dts/sun7i-a20-lamobo-r1.dtb := mkdir -p arch/arm/dts/ ; cat arch/arm/dts/sun7i-a20-lamobo-r1.dts  | sed '/^\/ {$$/{x;s%$$%\#include \"./arch/arm/dts/sunxi-u-boot.dtsi\"%;G;}' | arm-linux-gcc -E -Wp,-MD,arch/arm/dts/.sun7i-a20-lamobo-r1.dtb.d.pre.tmp -nostdinc -I./arch/arm/dts -I./arch/arm/dts/include -Iinclude -I./include -I./arch/arm/include -include ./include/linux/kconfig.h -D__ASSEMBLY__ -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/dts/.sun7i-a20-lamobo-r1.dtb.dts.tmp - ; dtc -O dtb -o arch/arm/dts/sun7i-a20-lamobo-r1.dtb -b 0 -i arch/arm/dts/    -d arch/arm/dts/.sun7i-a20-lamobo-r1.dtb.d.dtc.tmp arch/arm/dts/.sun7i-a20-lamobo-r1.dtb.dts.tmp ; cat arch/arm/dts/.sun7i-a20-lamobo-r1.dtb.d.pre.tmp arch/arm/dts/.sun7i-a20-lamobo-r1.dtb.d.dtc.tmp > arch/arm/dts/.sun7i-a20-lamobo-r1.dtb.d

source_arch/arm/dts/sun7i-a20-lamobo-r1.dtb := arch/arm/dts/sun7i-a20.dtsi

deps_arch/arm/dts/sun7i-a20-lamobo-r1.dtb := \
...
arch/arm/dts/sun7i-a20-lamobo-r1.dtb: $(deps_arch/arm/dts/sun7i-a20-lamobo-r1.dtb)

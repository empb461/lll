cmd_arch/arm/cpu/armv7/nonsec_virt.o := arm-linux-gcc -Wp,-MD,arch/arm/cpu/armv7/.nonsec_virt.o.d  -nostdinc -isystem /home/leela/mywork/buildroot-2017.02/output/host/usr/lib/gcc/arm-buildroot-linux-uclibcgnueabihf/5.4.0/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -D__ASSEMBLY__ -g -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7 -I./arch/arm/mach-sunxi/include   -c -o arch/arm/cpu/armv7/nonsec_virt.o arch/arm/cpu/armv7/nonsec_virt.S

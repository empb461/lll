cmd_spl/arch/arm/cpu/armv7/nonsec_virt.o := arm-linux-gcc -Wp,-MD,spl/arch/arm/cpu/armv7/.nonsec_virt.o.d  -nostdinc -isystem /home/leela/mywork/buildroot-2017.02/output/host/usr/lib/gcc/arm-buildroot-linux-uclibcgnueabihf/5.4.0/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -D__ASSEMBLY__ -g -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7 -I./arch/arm/mach-sunxi/include   -c -o spl/arch/arm/cpu/armv7/nonsec_virt.o arch/arm/cpu/armv7/nonsec_virt.S
...
deps_spl/arch/arm/cpu/armv7/nonsec_virt.o := \
    ...
    $(wildcard include/config/smp/pen/addr.h) \

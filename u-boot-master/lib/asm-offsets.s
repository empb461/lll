	...
	.file	"asm-offsets.c"
@ GNU C11 (Buildroot 2017.02) version 5.4.0 (arm-buildroot-linux-uclibcgnueabihf)
...
@ -I ./arch/arm/mach-sunxi/include
@ -isysroot /home/leela/mywork/buildroot-2017.02/output/host/usr/arm-buildroot-linux-uclibcgnueabihf/sysroot
@ -D __KERNEL__ -D __UBOOT__ -D __ARM__ -D __LINUX_ARM_ARCH__=7
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /home/leela/mywork/buildroot-2017.02/output/host/usr/lib/gcc/arm-buildroot-linux-uclibcgnueabihf/5.4.0/include
...
@ -mfpu=vfpv4 -mtls-dialect=gnu -auxbase-strip lib/asm-offsets.s -g -Os
...
.ascii "->GD_SIZE #208 sizeof(struct global_data)"	@
@ 0 "" 2
	.loc 1 30 0
...
.LASF19:
	.ascii	"/home/leela/mywork/UBOOT_WORK/u-boot-master\000"
.LASF15:
...
.LASF17:
	.ascii	"GNU C11 5.4.0 -marm -mno-thumb-interwork -mabi=aapc"
	.ascii	"s-linux -mword-relocations -mno-unaligned-access -m"
	.ascii	"float-abi=soft -march=armv7-a -mfpu=vfpv4 -mtls-dia"
	.ascii	"lect=gnu -g -Os -fno-builtin -ffreestanding -fno-st"
	.ascii	"ack-protector -fno-delete-null-pointer-checks -fsta"
	.ascii	"ck-usage -fno-pic -ffunction-sections -fdata-sectio"
...
.LASF8:
	.ascii	"sizetype\000"
	.ident	"GCC: (Buildroot 2017.02) 5.4.0"
